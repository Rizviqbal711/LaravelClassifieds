    ...
    <ol>
        <li>
            ...
            <ol>
                ...
                <li>
                    By accessing the Website in any manner, you give your consent and agree to be bound by the Terms.
                </li>
            </ol>
        </li>
        <li>
            ...
            <ol>
                <li>
                    You agree that your act of using our Website and Services is subject to these Terms, which may be amended from time to time with or without your notice.
                </li>
                <li>
                    The Website is owned and operated by the Company and is currently covering the UAE region. The Company reserves the sole right to modify or discontinue, temporarily or permanently, and at any time, the Website and/or the Website Services (or any part thereof) with or without notice.
                </li>
                <li>
                    The Company may modify these Terms from time to time, and any change to these Terms will be reflected on the Website with the updated version of the Terms and you agree to be bound to any changes to these Terms when you use the Website or the Services.
                </li>
                <li>
                    The Website uses cookies and by using the Website in any manner whatsoever, you also agree and consent to the use of cookies in accordance with the terms of the Privacy and Cookies policies.
                    <br/>
                    <br>
        ...
        <li>
            ...
            <ol>
                ...
                <li>
                    You must notify the Website by emailing us at info@quicklist.io if you have reason to believe that your account is no longer secure for any reason (for example, in the event of a loss, theft or unauthorized disclosure or use of your password).
                </li>
                <li>
        ...
        <li>
            ...
            <ol>
                ...
                <li>
                    Notice of Infringement must be sent to the Website via info@quicklist.io.
                </li>
            </ol>
        </li>
        <li>
        ...
        <li>
            ...
            <ol>
                <li>
                    YOU EXPRESSLY ACKNOWLEDGE AND AGREE THAT USE OF THE WEBSITE AND THE SERVICE IS ENTIRELY AT YOUR OWN RISK AND THAT THE WEBSITE AND THE SERVICE ARE PROVIDED ON AN "AS IS" OR "AS AVAILABLE" BASIS, WITHOUT ANY WARRANTIES OF ANY KIND. ALL EXPRESS AND IMPLIED WARRANTIES,
                    <br/>
        ...
        <li>
            ...
            <ol>
                <li>
                    The Website includes hyperlinks to other websites owned and operated by third parties; such hyperlinks are not recommendations. Goods and services of third parties may be advertised and/or made available on or through this web site.
                </li>
                <li>
                ...
                <li>
                    The Website may contain links from third party websites. You are solely responsible for complying with the terms and conditions for the third party sites. You acknowledge that the Company shall have no liability for any damage or loss arising from your access to any third party website, software, data or other information.
                </li>
                <li>
        ...
        <li>
            ...
            <ol>
                <li>
                    The term hereof shall begin on the date that comes first among: (i) first access to the Website; (ii) your first access or execution of our Services; or (iii) the Company begins providing its Services to you.
                </li>
                <li>
        ...
        <li>
            <strong>
                Account Termination and Discontinuation of Use
            </strong>
            <ol>
                <li>
                ...
                <li>
                    We will have no liability whatsoever on account of any change to the Service or any suspension or revocation of your access to or use of the Website. You may terminate your account at any time by sending us an email to info@quicklist.io.
                </li>
            </ol>
        </li>
        <li>
        ...
        <li>
            ...
            <ol>
                ...
                <li>
                    ...
                    The Company hereby reserves the right, at its sole and final discretion, to review any and all content delivered into the Website, and use moderators and/or any monitoring technology to flag and remove any user generated content or other content deemed inappropriate.
                </li>
                <li>
                    <span style="text-decoration: underline;">
                        <strong>
                ...
                <li>
                    ...
                    Your use of this Website and any cause of action, claim and/or dispute that might arise between the parties hereon, shall be subject to the laws of UAE, without regard to conflict of law principles.
                </li>
            </ol>
        </li>
    </ol>
